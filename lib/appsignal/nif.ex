...
defmodule Appsignal.Nif do
  ...
  def set_span_error(reference, name, message, backtrace) do
    _set_span_error(reference, name, message, backtrace)
  end
  ...
  def _set_span_error(reference, name, message, backtrace) do
    :ok
  end
